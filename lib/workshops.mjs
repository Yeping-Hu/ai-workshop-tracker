...
const TRACK_SUFFIX =
  /[-_](non[-_]?)?(archival|proceedings?|findings|extended[-_]abstracts?|abstracts?|track([-_]\d+)?|main|tiny|tutorials?|late([-_](breaking|submissions))?|arr[-_]commitment|fast|competition|paper|demonstration|position|community|early[-_]bird|rolling)$/i;
